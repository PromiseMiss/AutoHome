...
public class CustomRefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private OnCustomRefreshListener mOnRefreshListener;  //刷新接口
     ...
     */
    public void setOnCustomRefreshListener(OnCustomRefreshListener onRefreshListener) {
    ...
    private void init(Context context) {
        ...
        //加载头布局
        headView = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.custom_refresh_headview, this, false);
        //测量头布局
        ...
        backAnimation1 = AnimationUtils.loadAnimation(context, R.anim.input_custom);
        backAnimation2 = AnimationUtils.loadAnimation(context, R.anim.out_custom);
